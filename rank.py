...
####################################### Task Extra ###############################################
def task_extra(queries, features, doc_freq):
    return {}
...
def main(task_number, featureFile):
    #output file name
    ...
    if task_number == 0:
        ...
        rankedQueries = task_extra(queries, features, term_doc_freq)       
